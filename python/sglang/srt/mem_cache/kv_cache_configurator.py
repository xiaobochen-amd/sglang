...
def calculate_mla_kv_cache_dim(
    *,
    ...
    # On HIP, the TileLang, AITER and Triton DSA kernels consume the raw MLA KV
    # layout: nope(512 fp8) + rope(64 fp8), without extra per-block scales.
    if _is_hip and (
        server_args.dsa_prefill_backend in ("tilelang", "aiter", "triton")
        or server_args.dsa_decode_backend in ("tilelang", "aiter", "triton")
    ):
        return kv_cache_dim
